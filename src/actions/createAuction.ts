...
const createAuctionTemplate = `Respond with an XML block containing only the extracted values. Use key-value pairs. Use <null/> for any values that cannot be determined.

Example response:
<response>
  <nftAddress>&lt;NFT address for auction&gt;</nftAddress>
  <minimumBid>&lt;Minimum bid in TON&gt;</minimumBid>
  <maximumBid>&lt;Maximum bid/buyout price in TON&gt;</maximumBid>
  <expiryTime>&lt;Auction expiry time in hours&gt;</expiryTime>
</response>
