...
export const passwordTemplate = `Respond with an XML block containing only the extracted values. Use key-value pairs. Use <null/> for any values that cannot be determined.

Example response:
<response>
  <encryptionPassword>&lt;your password here&gt;</encryptionPassword>
</response>
